...
public class CentellaAsiaticaToner extends Toner implements IGiveTips {
    ...
    public String giveTips(String skinType) {
        return switch (skinType) {
            case "Normal Skin" -> "Use Centella toner when your skin feels overworked or stressed (e.g., after travel, sun, or too many actives). It will calm things down quickly.";
