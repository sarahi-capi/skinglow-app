...
public class ChemicalSunscreen extends Sunscreen implements IGiveTips {
    ...
    public String giveTips(String skinType) {
        return switch (skinType) {
            case "Normal Skin" -> "You can choose nearly any texture (gel, fluid, cream) — feel free to experiment. Layer over your usual skincare and use it as the last step of your morning routine.";
